...
// src/discover-agents.ts
var args = new Set(process.argv.slice(2));
var json = args.has("--json");
var explain = args.has("--explain");
var includeProjectOnly = args.has("--include-project-only");
var found = discoverAgents({ includeProjectOnly });
if (json) {
